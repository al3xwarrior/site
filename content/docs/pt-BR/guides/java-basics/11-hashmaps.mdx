...
scores.put("Bob", 150);
scores.put("Alice", 200);     // Atualiza o existente (Alice agora tem 200)
```
...
Integer missing = scores.get("Dave");   // nulo (inexistente)
...
boolean hasAlice = scores.containsKey("Alice");    // verdadeiro
boolean hasDave = scores.containsKey("Dave");      // falso

boolean has100 = scores.containsValue(100);        // verdadeiro
...
public class Player {
    ...
    public String toString() {
        return name + " (Nv. " + level + ", PV: " + health + ")";
    }
}
...
// Adiciona jogador com estatísticas
