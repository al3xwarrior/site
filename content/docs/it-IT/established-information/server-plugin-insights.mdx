...
<Callout type="info" title="Nota">
  Le seguenti informazioni si basano su informazioni condivise dal direttore tecnico Slikey il 15 dicembre 2025 sul server Hytale Discord. It provides an overview of the server code architecture and plugin capabilities.
